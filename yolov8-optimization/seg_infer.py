...
def plot_result(det_cpu, dst_img, masks, category_names):
    for i, item in enumerate(det_cpu):
        ...
        dst_img[box_y1:box_y2, box_x1:box_x2] = cv2.addWeighted(bbox_image, 1, mask_colored, 1, 0)
...
def test_yolov8_segment():
    ...
    parser.add_argument('--data', default='assets/rs00058.jpg', type=str, help='Images file')
    ...
    # 画图
    plot_result(det.cpu().numpy(), ori_img, masks, category_names)
