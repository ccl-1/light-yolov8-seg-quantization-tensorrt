...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           'GhostBottleneck', 'Bottleneck', 'BottleneckCSP', 'Proto', 'RepC3', 'PConv', 'C3_Faster', 'C2f_Faster',
           'C3_Faster_EMA', 'C2f_Faster_EMA')
...
class C3_Faster(C3):
    # C3 module with cross-convolutions # shortcut为 true or false，默认应该false 才对... 都测一下，看一下输出结果... 
